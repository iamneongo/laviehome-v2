import type { InfobarContent } from '@/starter/components/ui/infobar';
  ...
  sections: [
    {
      ...
      description:
        'Data is prefetched on the server using getQueryClient().prefetchQuery(). The dehydrated state is passed to HydrationBoundary so the client starts with cached data â€” no loading spinners on first load.',
      links: [
        {
