// ============================================================
// Product Service â€” Data Access Layer
// ============================================================
...
//    â†’ return apiClient<ProductsResponse>('/products?...')
//    â†’ Replace mock calls in route handlers (src/app/api/products/) with ORM
//
...
//    â†’ const res = await fetch('https://your-api.com/products?...')
//    â†’ return res.json()
//
