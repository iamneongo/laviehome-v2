...
import { productSchema, type ProductFormValues } from '@/starter/features/products/schemas/product';
import { categoryOptions } from '@/starter/features/products/constants/product-options';
