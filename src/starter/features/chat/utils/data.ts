...
export const initialConversations: Conversation[] = [
  {
    ...
    autoReplies: [
      ...
      'Absolutely â€” I just emailed the refund confirmation to your registered address.',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        sender: 'contact',
        author: 'Priya',
        text: "I checked your API key â€” it's on the Starter tier which has a 30 req/min limit. You'll need the Growth plan for 200 req/min. Would you like me to upgrade it?",
        timestamp: '09:18'
      },
      {
        id: 'api-3',
      ...
      },
      {
        ...
        sender: 'contact',
        author: 'Priya',
        text: "Great question â€” our SDK handles this automatically if you enable `autoRetry: true` in the config. I'll send you a code snippet.",
        timestamp: '09:25'
      }
    ],
    quickReplies: [
    ...
    autoReplies: [
      "Here's the code snippet â€” just add `autoRetry: true` and `maxRetries: 3` to your client config.",
  ...
  },
  {
    ...
    messages: [
      {
        ...
        sender: 'contact',
        author: 'Jordan',
        text: "We noticed a login attempt from an unrecognized device in SÃ£o Paulo. Was this you? We've temporarily locked the session as a precaution.",
        timestamp: 'Yesterday'
      },
      {
        id: 'access-2',
    ...
    autoReplies: [
      ...
      "Done â€” you'll receive a password reset link shortly. Make sure to use a unique password.",
      'No data was accessed â€” the session was blocked before any API calls were made. Your account is secure.'
    ]
  }
];
