...
import {
  ...
  FormErrors,
  scrollToFirstError
} from '@/starter/components/ui/tanstack-form';
        ...
        <form.AppForm>
          <form.Form className='space-y-6'>
            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
              {/* Username â€” async validation (spinner built into FormTextField) */}
              <FormTextField
                name='username'
                label='Username'
                required
              ...
              {/* Confirm Password â€” linked validation via AppField render prop */}
              <form.AppField
            ...
            {/* â”€â”€â”€ Section 2: Team Info (nested objects) â”€â”€â”€ */}
            <div className='space-y-1'>
            ...
            {/* â”€â”€â”€ Section 3: Members (dynamic array rows) â”€â”€â”€ */}
            <div className='space-y-1'>
            ...
            {/* â”€â”€â”€ Section 4: Preferences (listeners / side effects) â”€â”€â”€ */}
            <div className='space-y-1'>
              <h3 className='text-lg font-semibold'>Preferences</h3>
              <p className='text-muted-foreground text-sm'>
                Listener side effects â€” country resets state
              </p>
            </div>
