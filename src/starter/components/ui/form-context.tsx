/**
 * form-context.tsx â€” Shared primitives for the TanStack Form + shadcn/ui integration.
 *
 * This file provides:
 ...
 *  - createFormField() â€” wraps a base field into a flat, self-wiring component
 *  - FieldConfig types â€” validators, listeners, asyncDebounceMs
...
import {
  ...
  fieldVariants
} from '@/starter/components/ui/field';
...
interface FieldValidatorConfig {
  /** Sync validator â€” runs on every value change. Accepts a function or Zod schema. */
  onChange?: unknown;
  /** Async validator â€” runs on value change (debounced). */
  ...
  /** Sync validator â€” runs when the field loses focus. Accepts a function or Zod schema. */
  onBlur?: unknown;
  /** Async validator â€” runs on blur. */
  onBlurAsync?: unknown;
  /** Debounce (ms) for onBlurAsync. */
  onBlurAsyncDebounceMs?: number;
  /** Re-run onBlur/onBlurAsync when these other fields blur. */
  onBlurListenTo?: string[];
  /** Sync validator â€” runs on form submission. */
  onSubmit?: unknown;
  /** Async validator â€” runs on form submission. */
  onSubmitAsync?: unknown;
  /** Sync validator â€” runs on field mount. */
  onMount?: unknown;
}
...
// ---------------------------------------------------------------------------
// 5. createFormField â€” lifts a field component into a flat form-level component
//
 ...
 * <TypedDatePicker name="birthDate" />  // âœ… type-safe
 * ```
 */
