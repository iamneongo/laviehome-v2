/**
 * tanstack-form.tsx â€” Main entry point for the form system.
 *
...
import { Button, type buttonVariants } from '@/starter/components/ui/button';
import {
  FieldContent,
  FieldDescription,
  FieldGroup,
...
import { InputGroup, InputGroupAddon, InputGroupInput } from '@/starter/components/ui/input-group';
import {
  TextField,
  TextareaField,
  SelectField,
  ...
  FormSliderField,
  FormFileUploadField
} from '@/starter/components/forms/fields';
...
const { useAppForm, withForm, withFieldGroup } = createFormHook({
  ...
  formComponents: {
    ...
    FieldDescription,
    FieldSeparator,
    // Composed field components (flat API â€” convenience pattern)
...
// ---------------------------------------------------------------------------
// Type-safe field names â€” useFormFields
// ---------------------------------------------------------------------------
 ...
 *
 * <FormTextField name="email" />  // âœ… autocomplete + type check
 * <FormTextField name="typo" />   // âŒ TypeScript error!
 * ```
 */
