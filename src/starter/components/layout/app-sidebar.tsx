'use client';
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from '@/starter/components/ui/collapsible';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
import { useMediaQuery } from '@/starter/hooks/use-media-query';
