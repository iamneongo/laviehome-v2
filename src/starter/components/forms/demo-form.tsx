...
import { useAppForm, useFormFields } from '@/starter/components/ui/tanstack-form';
import { useStore } from '@tanstack/react-form';
import * as z from 'zod';
import { Button } from '@/starter/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle } from '@/starter/components/ui/card';
import { FieldDescription } from '@/starter/components/ui/field';
import { Input } from '@/starter/components/ui/input';
import { Checkbox } from '@/starter/components/ui/checkbox';
import { Badge } from '@/starter/components/ui/badge';
import { Separator } from '@/starter/components/ui/separator';
import { ToggleGroup, ToggleGroupItem } from '@/starter/components/ui/toggle-group';
import {
  InputOTP,
  InputOTPGroup,
  InputOTPSlot,
  InputOTPSeparator
} from '@/starter/components/ui/input-otp';
...
import {
  ...
  CommandItem,
  CommandList
} from '@/starter/components/ui/command';
import { Calendar } from '@/starter/components/ui/calendar';
import { Label } from '@/starter/components/ui/label';
import { format } from 'date-fns';
import type { DateRange } from 'react-day-picker';
import { Icons } from '@/starter/components/icons';
import { cn } from '@/starter/lib/utils';

// Schema (form-level safety net â€” onSubmit catches anything field-level missed)
...
// â”€â”€â”€ Custom field components (no pre-built field component exists) â”€â”€â”€
...
export default function DemoForm() {
  const form = useAppForm({
    ...
    validators: {
      // Form-level safety net â€” catches anything field-level validators missed
      ...
      <Card>
        <CardHeader>
          ...
          <p className='text-muted-foreground'>
            Every possible form input â€” built with TanStack Form + shadcn/ui
          </p>
        </CardHeader>
        <CardContent>
          <form.AppForm>
            <form.Form className='space-y-6'>
              {/* â”€â”€â”€ TEXT INPUTS (flat pattern + field-level onBlur validation) â”€â”€â”€ */}
                ...
                <FormTextField
                  ...
                  validators={{
                    ...
                    onChangeAsync: async ({ value }: { value: string }) => {
                      ...
                      // Simulated server check â€” replace with real API call
              ...
              {/* â”€â”€â”€ TEXTAREA (flat pattern + onBlur validation) â”€â”€â”€ */}
              <FormTextareaField
                name='bio'
                label='Bio'
                required
              ...
              <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                ...
                {/* Combobox â€” custom, needs AppField (type-safe name) */}
                <form.AppField
                  name='framework'
                  children={(field) => (
                    <field.FieldSet>
              ...
              {/* Checkbox Group â€” array mode, needs AppField */}
              <form.AppField
                name='interests'
                mode='array'
                children={(field) => {
              ...
              {/* Toggle Group â€” array mode, needs AppField */}
              <form.AppField
                name='formatting'
                mode='array'
                children={(field) => {
              ...
              {/* Terms checkbox â€” custom horizontal layout, needs AppField */}
              <form.AppField
                name='terms'
                children={(field) => (
                  <field.FieldSet>
              ...
              {/* â”€â”€â”€ SLIDER (flat pattern) â”€â”€â”€ */}
              ...
              {/* â”€â”€â”€ DATE & TIME (custom, need AppField) â”€â”€â”€ */}
              ...
              {/* â”€â”€â”€ SPECIAL INPUTS (custom, need AppField) â”€â”€â”€ */}
              ...
              {/* Tags Input â€” array mode, needs AppField */}
              <form.AppField
                name='tags'
                mode='array'
                children={(field) => {
              ...
              {/* â”€â”€â”€ FILE UPLOAD (flat pattern) â”€â”€â”€ */}
